...
racc_action_table = [
    -6,    50,     7,     7,    18,    18,     7,   -14,   -13,    40,
    41,    42,    43,     7,   -11,    18,   -11,     7,    30,    40,
    41,    42,    43,     7,   -11,    18,     7,     7,    18,    40,
    41,    42,    43,     7,   -11,    18,    11,    53,    26,    40,
    41,    42,    43,     7,   -11,    18,    26,     7,   -13,    18,
     7,     7,    18,    18,     7,     7,    18,    18,   -11,     7,
   -11,     7,    55,    56,    57,    30,     7,     7,     7,     7,
     7,    27,    66,    67,    68,    69,    70,    26,    12,    11,
     8,    54 ]

racc_action_check = [
    23,    30,    15,    23,    15,    23,    27,    15,    23,    23,
    23,    23,    23,    28,    28,    28,     3,     3,    28,    28,
    28,    28,    28,    33,    33,    33,    70,    26,    70,    33,
    33,    33,    33,    49,    49,    49,    31,    40,    31,    49,
    49,    49,    49,     9,     9,     9,    25,    66,     9,    66,
    57,    67,    57,    67,    69,    68,    69,    68,    14,    14,
     0,     0,    42,    43,    45,    21,    50,    53,    54,    55,
    56,    18,    58,    59,    60,    61,    62,    17,     8,     6,
     1,    41 ]

racc_action_pointer = [
    58,    80,   nil,    14,   nil,   nil,    77,   nil,    78,    40,
   nil,   nil,   nil,   nil,    56,    -1,   nil,    73,    65,   nil,
   nil,    57,   nil,     0,   nil,    42,    24,     3,    10,   nil,
    -5,    34,   nil,    20,   nil,   nil,   nil,   nil,   nil,   nil,
    31,    75,    56,    57,   nil,    57,   nil,   nil,   nil,    30,
    63,   nil,   nil,    64,    65,    66,    67,    47,    65,    66,
    67,    68,    69,   nil,   nil,   nil,    44,    48,    52,    51,
    23,   nil,   nil,   nil,   nil,   nil ]

racc_action_default = [
    -5,   -45,    -1,    -6,    -7,    -9,   -45,   -12,   -45,    -3,
    -8,   -10,    76,    -2,    -5,   -11,   -15,   -45,   -45,   -19,
   -20,   -45,    -4,   -11,   -16,   -24,   -11,   -11,   -30,   -26,
   -45,   -45,   -21,   -22,   -23,   -32,   -35,   -36,   -37,   -38,
   -45,   -45,   -45,   -45,   -17,   -45,   -25,   -27,   -28,   -31,
   -11,   -33,   -34,   -11,   -11,   -11,   -11,   -11,   -45,   -45,
   -45,   -45,   -45,   -18,   -43,   -44,   -11,   -11,   -11,   -11,
   -11,   -29,   -39,   -40,   -41,   -42 ]

racc_goto_table = [
     6,    10,    51,     6,    13,    16,    29,    33,     3,    17,
    14,    24,    49,    47,     6,    25,    20,     5,    51,    16,
     5,    10,    23,     2,    48,    19,     6,    45,    17,    52,
    34,     5,    28,    17,    46,     9,     1,    22,   nil,    32,
     5,   nil,   nil,    44,   nil,    52,   nil,   nil,    63,    17,
    58,   nil,   nil,    59,    60,    61,    62,    71,    72,    73,
    74,    75 ]

racc_goto_check = [
     9,     7,    20,     9,     3,    12,    19,    16,     6,     9,
     5,    12,    16,    19,     9,     9,    15,     8,    20,    12,
     8,     7,     6,     2,    12,    14,     9,     9,     9,    12,
    15,     8,    17,     9,    18,     4,     1,     2,   nil,    14,
     8,   nil,   nil,     8,   nil,    12,   nil,   nil,    13,     9,
     9,   nil,   nil,     9,     9,     9,     9,    13,    13,    13,
    13,    13 ]

racc_goto_pointer = [
   nil,    36,    23,    -5,    33,     1,     8,    -2,    17,     0,
   nil,   nil,    -4,    -9,    16,     7,   -16,    11,     6,   -15,
   -31,   nil,   nil,   nil,   nil ]

racc_goto_default = [
   nil,   nil,   nil,   nil,   nil,   nil,   nil,     4,    64,    31,
    21,    15,    65,   nil,   nil,   nil,   nil,   nil,   nil,   nil,
    35,    36,    37,    38,    39 ]
